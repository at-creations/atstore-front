...
export function ProductDetails({ product, locale='en' }: ProductDetailsProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="w-full max-w-2xl mx-auto">
          <ImageCarousel
            ...
            productName={locale === 'vi' && product.name_vi ? product.name_vi : product.name}
          />
        </div>
        <div>
          ...
          <p className="text-xl text-blue-600 dark:text-blue-400 font-bold mb-4">${product.price}</p>
